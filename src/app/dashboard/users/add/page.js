const AddUser = () => {
  return (
      <form className="flex flex-col items-center w-full p-4 gap-4 text-xl text-color2 h-full">
        ...
        <div className="w-full flex items-center justify-between">
          <input className="rounded-lg border-2 border-color2 py-3 px-4 w-[45%]" type="text" name="password" placeholder="Password" />
        ...
        <div className="w-full flex items-center justify-between">
          ...
          </select><select className="rounded-lg border-2 border-color2 py-3 px-4 w-[45%]" name="isActive">
            <option value="true">Active</option>
            <option value="false">Not Active</option>
          </select>
        </div>
        <textarea className="rounded-lg border-2 border-color2 w-full flex-grow p-4" name="address" placeholder="Address" />
        <button className="w-full py-3 text-2xl bg-color2 text-white rounded-lg">Submit</button>
      </form>
  )
}
